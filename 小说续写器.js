...
const SCRIPT_ID = 'novel-writer-' + Math.random().toString(36).substr(2, 9);
...
jQuery(async () => {
    ...
    $(window).on('pagehide', () => {
        try {
            ...
            $('style[data-novel-writer]').remove();
 ...
 * ▌SECTION 4  入口 & 卸载清理
 * ------------------------------------------------------------
 * 业务代码末尾已有 jQuery(async () => {...}) 入口，
 * 其中已注入 UI_HTML / UI_CSS 并注册 pagehide 卸载清理。
 * ============================================================ */
